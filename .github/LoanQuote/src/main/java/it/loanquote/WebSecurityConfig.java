...
import it.aifa.authentication.filter.AifaAuthenticationFilter;
import it.aifa.log.RequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity httpSecurity) throws Exception {
    ...
    httpSecurity.authorizeRequests().anyRequest().authenticated().and()
        ...
        .addFilterAfter(requestFilterBean(), AifaAuthenticationFilter.class);

    httpSecurity.headers().cacheControl();
  }

  public AifaAuthenticationFilter aifaAuthenticationFilterBean() {
    return new AifaAuthenticationFilter(testMode);
  }
